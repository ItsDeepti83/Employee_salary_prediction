...
# st.markdown("---")
# st.markdown(
#     "<p style='text-align: center; color: white;'>Created by Monish Khan as a Part of my AI/ML Internship at IBM</p>",
#     unsafe_allow_html=True
# )
# 🎨 Footer
st.markdown("---")
st.markdown("##### ✨ Created by Deepti Sabat as a part of my AI/ML Internship at IBM", unsafe_allow_html=True)